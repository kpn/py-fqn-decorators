# -*- coding: utf-8 -*-
#
# decorator-utils documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'fqn-decorators.tex', u'FQN Decorators Documentation',
     u'Mattias Sluis', 'manual'),
]
...
man_pages = [
    (master_doc, 'fqn-decorators', u'FQN Decorators Documentation',
     [author], 1)
]
